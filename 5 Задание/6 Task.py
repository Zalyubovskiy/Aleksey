"""
Задание-6. Необходимо создать (не программно) текстовый файл, где
...
"""
obj = {}
with open("Task6.txt", "r", encoding="utf-8") as meet:
    for line in meet:
        name_sub, lecture, practice, labor = line.split()
        obj[name_sub] = int(lecture) + int(practice) + int(labor)
